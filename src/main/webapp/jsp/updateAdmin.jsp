...
<div class="container" id="container">
    <h2>管理员注册</h2>
    <% UserDto userDto=(UserDto) request.getAttribute("admin"); %>
    <form action="updateAdmin.do" id="form1">
        <div class="form-group">
            <label for="userName">用户名</label>
            <input type="hidden" name="id" value="<%=userDto.getId() %>">
            <input type="text" class="form-control" placeholder="必须由字母，数字，下划线组成。并且长度是5到12位" value="<%=userDto.getUserName() %>" name="userName" id="userName">
        </div>
        <div class="form-group">
            <label for="password1">密码</label>
            <input type="password" class="form-control" placeholder="请输入密码，至少8位有效数字" name="password" value="<%=userDto.getPassword() %>" id="password1">
        </div>
        <div class="form-group">
