...
<div class="container">
    ...
    <form action="updateOrder.do" id="form1">
        <div class="form-group">
            <label for="productName">订单名称</label>
            <input type="text" class="form-control"  name="productName" id="productName" value="<%=order.getProductName() %>">
        </div>
        <div class="form-group">
            <input type="hidden" name="id" value="<%=order.getId() %>">
            <label for="productNumber">产品数</label>
            <input type="text" class="form-control" name="productNumber" id="productNumber" value="<%=order.getProductNumber() %>">
        </div>
        <div class="form-group">
            <label for="productUnit">单位</label>
            <input type="text" class="form-control" name="productUnit" id="productUnit" value="<%=order.getProductUnit() %>">
        </div>
        <div class="form-group">
            <label>配送司机</label>
            <input type="text" class="form-control" value="<%=order.getDeliverman() %>" name="deliverman">
        </div>
