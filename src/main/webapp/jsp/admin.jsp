...
<div class="main-wrapper">
    ...
    <% PageInfo pi=(PageInfo)request.getAttribute("admins"); %>
    <% List<UserDto> list=pi.getList(); %>
    <div class="main-wrapper">
        <div class="container">
            <span><h2>管理员信息</h2></span>
            <span>
		    <form class="example" action="searchAdmin.do?se" style="margin:auto;max-width:300px">
            ...
            <div align="center" class="bg container">
                ...
                <%if(pi.getPrePage()>0){ %>
                <li class = "page-item"><a href="glyxx.do?ym=<%=pi.getPrePage()%>" class="page-link"
