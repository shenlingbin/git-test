...
<div class="main-wrapper">
    ...
    <div class="main-wrapper">
        <div class="container">
            ...
            <span>
		    <form class="example" action="driverSearchCustomer.do" style="margin:auto;max-width:300px">
            ...
            <div align="center" class="bg container">
                <ul class="pagination">
                    ...
                    <%if(pi.getPrePage()>0){ %>
                    <li class = "page-item"><a href="dkhxx.do?ym=<%=pi.getPrePage()%>" class="page-link" aria-lable="Previous">&laquo;</a></li>
                    <%} %>
                    <% for(int i:pi.getNavigatepageNums()){ %>
                    <li class = "page-item"><a href="dkhxx.do?ym=<%=i%>" class="page-link">&nbsp;<%=i %>&nbsp;</a></li>
                    <%} %>
                    <!-- 判断当前页是否存在下一页，不存在则不显示下一页的按钮 -->
                    <% if(pi.getPageNum()<pi.getLastPage()){ %>
                    <li class="page-item"><a href="dkhxx.do?ym=<%=pi.getNextPage()%>" class="page-link" aria-lable="Next" >&raquo;</a></li>
                    <%} %>
                </ul>
            </div>
        </div>
