...
<div class="container">
    ...
    <form action="customerUpdate.do" id="form1">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  name="userName" id="userName" value="<%=customer.getUserName() %>">
        </div>
        <div class="form-group">
            <label>性别</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="<%=customer.getOrdersNumber()%>" name="ordersNumber" id="ordersNumber">
        </div>
        <div class="form-group">
            <label for="phone">手机号</label>
            <input type="text" class="form-control" value="<%=customer.getPhone()%>" name="phone" id="phone">
        </div>
        <div class="form-group">
            <label>车型</label>
            <input type="text" class="form-control" value="<%=customer.getAddress() %>" name="address">
        </div>
