...
<div class="container">
    <h2>添加司机</h2>
    <form action="AddDriver.do" method="post" id="form1">
        ...
        <div class="form-group">
            <label>车型</label>
            <input type="text" class="form-control" placeholder="请输入车辆型号" name="carType">
        </div>
        <div class="form-group">
            <label>路线</label>
            <input type="text" class="form-control" placeholder="请输入路线" name="path">
        </div>
